/*
    ...
    debugout.js
	by @inorganik
	revision by @abrenoch
    
*/

const DEFAULT_FILENAME = 'debugout.txt';
const MAX_LINES = 2500;
const MAX_OBJECT_DEPTH = 25;

// save all the console.logs
class debugout {

	constructor(maxLines = MAX_LINES, filename = DEFAULT_FILENAME, maxDepth = MAX_OBJECT_DEPTH) {
		// OPTIONS
		...
		this.maxLines = maxLines; // if autoTrim is true, this many most recent lines are saved
		this.tailNumLines = 100; // how many lines tail() will retrieve
		this.logFilename = filename; // filename of log downloaded with downloadLog()
		this.maxDepth = maxDepth; // max recursion depth for logged objects
	...
	*/
	...
	tail (numLines) {
		let numLines = numLines || this.tailLines;
